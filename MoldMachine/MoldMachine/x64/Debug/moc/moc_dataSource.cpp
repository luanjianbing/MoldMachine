...
QT_MOC_LITERAL(1, 11, 17), // "sendDataSrcChosen"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 18) // "buttonApplyClicked"

    },
    "DataSource\0sendDataSrcChosen\0\0"
    "buttonApplyClicked"
};
...
void DataSource::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendDataSrcChosen((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        {
            using _t = void (DataSource::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DataSource::sendDataSrcChosen)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void DataSource::sendDataSrcChosen(int _t1)
{
