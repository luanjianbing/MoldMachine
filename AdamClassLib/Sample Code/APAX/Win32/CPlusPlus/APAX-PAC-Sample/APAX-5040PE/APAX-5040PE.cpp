// APAX-5040PE.cpp : Defines the entry point for the console application.
...
const int g_ChannelNum = 24; //the channel number of APAX_5040PE is 24
...
int main(int argc, char* argv[])
{
	...
	if (bAdvStatus = EX_OpenLib(&lDriverHandle))
	{
		...
		//the moduleID for Apax-5040 is 0x5045045
		//dHiWord is 5040, dLoWord is 5045
