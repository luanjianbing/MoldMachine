...
namespace APAX_5018
{
    public partial class Form_APAX_5018 : Form
    {
        // Global object
        const string APAX_INFO_NAME = "APAX";
        const string DVICE_TYPE = "5018";
        ...
        public Form_APAX_5018(string IP, int SlotNum, int ScanTime, AdamType i_adamType)
        {
            InitializeComponent();
            m_szSlots = null;
        ...
        private void btnBurnoutFcn_Click(object sender, EventArgs e)
        {
            ...
            if (m_adamSocket.AnalogInput().SetBurnoutFunEnable(m_idxID, m_uiBurnoutMask))
            {
        ...
        private void Form_APAX_5018_FormClosing(object sender, FormClosingEventArgs e)
        {
            FreeResource();
        }
