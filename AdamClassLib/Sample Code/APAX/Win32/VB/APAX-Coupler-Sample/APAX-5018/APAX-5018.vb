...
Public Class Form_APAX_5018
    ...
    Public Sub SetIntegrationComboBox(ByVal strIntegration() As String)
    ...
    Public Function Update_AI_UIStatus() As Boolean
        ...
        If m_usInVal.Length > 0 Then
            ...
            If (bHasTCRange AndAlso (((Me.m_iPollingCount * Timer1.Interval) Mod 5000) >= 0) AndAlso (((Me.m_iPollingCount * Timer1.Interval) Mod 5000) < 1)) Then
                ...
                If m_adamModbusSocket.AnalogInput.GetCJCValue(m_iSlot_ID, fCJCVal, o_Status) Then
    ...
    Private Sub btnBurnoutFcn_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBurnoutFcn.Click
        ...
        End If
        If m_adamModbusSocket.AnalogInput.SetBurnoutFunEnable(Me.m_iSlot_ID, m_uiBurnoutMask) Then
    ...
    Private Sub Form_APAX_5018_Closing(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles MyBase.Closing
        FreeResource()
    ...
    Private Sub Form_APAX_5018_FormClosing(ByVal sender As System.Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles MyBase.FormClosing
        FreeResource()
    End Sub
End Class
