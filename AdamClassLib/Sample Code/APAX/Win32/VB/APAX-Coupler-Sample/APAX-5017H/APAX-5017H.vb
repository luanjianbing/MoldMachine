...
Public Class Form_APAX_5017H
    ...
    Public Function DeviceFind() As Boolean
        ...
        If m_iSlot_ID = -1 Then
            ...
            For iLoop = 0 To m_szSlots.Length - 1
                If m_szSlots(iLoop) = Nothing Then
                    Continue For
                End If
                If ((String.Compare(m_szSlots(iLoop), 0, DVICE_TYPE, 0, DVICE_TYPE.Length) = 0) And m_szSlots(iLoop).Length = 5) Then
        ...
        Else
            ...
            If (String.Compare(m_szSlots(m_iSlot_ID), 0, DVICE_TYPE, 0, DVICE_TYPE.Length) = 0 And m_szSlots(m_iSlot_ID).Length = 5) Then
                iDeviceNum = iDeviceNum + 1
            End If
    ...
    Public Function Update_AI_UIStatus() As Boolean
        ...
        Else
            For i = 0 To Me.m_iAIChannelNum - 1
                ...
                listViewChInfo.Items(i).SubItems(4).Text = "******"
    ...
    Private Sub Form_APAX_5017H_FormClosing(ByVal sender As System.Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles MyBase.FormClosing
        FreeResource()
    End Sub
End Class