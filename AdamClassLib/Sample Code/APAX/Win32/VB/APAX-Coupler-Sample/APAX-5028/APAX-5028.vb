...
Public Class Form_APAX_5028
    ...
    Private Function RefreshAoStartupValues() As Boolean
        Try
            ...
            Dim iChannelTotal As Integer = Me.m_aConf.HwIoTotal(m_tmpidx)
            If m_adamModbusSocket.AnalogOutput.GetStartupValues(m_iSlot_ID, iChannelTotal, m_usStartupAO) Then
    ...
    Private Sub RefreshSafetySetting() ' Refresh Modules's Safety column value
        ...
        If Not m_adamModbusSocket.Configuration.OUT_GetSafetyEnable(m_iSlot_ID, m_bIsEnableSafetyFcn) Then
        ...
        If m_bIsEnableSafetyFcn Then
            ...
            If m_adamModbusSocket.AnalogOutput.GetSafetyValues(Me.m_iSlot_ID, Me.m_iAOChannelNum, o_usValues) Then
                m_usAOSafetyVals = o_usValues
                strSafetyValue = New String((m_iAOChannelNum) - 1) {}

                For i = 0 To m_iAOChannelNum - 1
                    listViewChInfo.Items(i).SubItems(6).Text = AnalogOutput.GetScaledValue(Me.m_usRanges(i), m_usAOSafetyVals(i)).ToString("0.000;-0.000")
                Next
        ...
        Else
            For i = 0 To m_iAOChannelNum - 1
                listViewChInfo.Items(i).SubItems(6).Text = "Disable"
            Next
            'moduify "Safety" column
        End If
    ...
    Private Sub tcRemote_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tcRemote.SelectedIndexChanged
        ...
        ElseIf (strSelPageName = "AO") Then
            ...
            idx = 0
            'initial index
            If m_adamModbusSocket.AnalogOutput.GetCurrentValue(m_iAOChannelNum, idx, usVal) Then
    ...
    Private Function RefreshData() As Boolean
        ...
        If Not m_adamModbusSocket.AnalogOutput.GetValues(m_iSlot_ID, m_iAOChannelNum, usVal) Then
            StatusBar_IO.Text = (StatusBar_IO.Text + ("ApiErr:" _
                        + (m_adamModbusSocket.AnalogOutput.ApiLastError.ToString + " ")))
            Return False
        End If
    ...
    Private Sub formSafety_ApplySafetyValueClick(ByVal szVal() As String) '  Apply setting when user configure safety status
        ...
        Do While (i < m_iAOChannelNum)
            ...
            i = (i + 1)
        Loop
        If Not m_adamModbusSocket.AnalogOutput.SetSafetyValues(Me.m_iSlot_ID, Me.m_iAOChannelNum, usAOSafetyVals) Then
            MessageBox.Show(("Set safety value failed! (Err: " _
                            + (m_adamModbusSocket.AnalogOutput.ApiLastError.ToString + ")")), "Error", MessageBoxButtons.OK, MessageBoxIcon.Hand, MessageBoxDefaultButton.Button1)
        End If
        RefreshSafetySetting()
    End Sub
    ...
    Private Sub chbxEnableSafety_CheckStateChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chbxEnableSafety.CheckStateChanged
        ...
        If Not CheckControllable() Then
            Return
        End If
        If Not m_adamModbusSocket.Configuration.OUT_SetSafetyEnable(Me.m_iSlot_ID, chbxEnableSafety.Checked) Then
    ...
    Private Sub btnApplyOutput_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnApplyOutput.Click
        ...
        Try
            ...
            End If
            'Set channel value
            If Me.m_adamModbusSocket.AnalogOutput.SetCurrentValue(Me.m_iSlot_ID, m_iSelChannels, m_usRanges(m_iSelChannels), fVal) Then
                RefreshOutputPanel(fHigh, fLow, fVal)
            Else
        ...
        If (result = DialogResult.Yes) Then
            ...
            If bRet Then
                ...
                Else
                    ...
                    Loop
                End If
                If m_adamModbusSocket.AnalogOutput.SetRanges(Me.m_iSlot_ID, m_iAOChannelNum, usRanges) Then
    ...
    Private Sub btnSetAsStartup_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSetAsStartup.Click
        ...
        Try
            ...
            usStartupAO(m_iSelChannels) = Convert.ToUInt16((65535.0! _
                            * ((fVal - fLow) _
                            / (fHigh - fLow))))
            If m_adamModbusSocket.AnalogOutput.SetStartupValues(Me.m_iSlot_ID, usStartupAO) Then
    ...
    Private Sub btnSetAsSafety_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSetAsSafety.Click
        ...
        Try
            ...
            usAOSafetyVals(m_iSelChannels) = Convert.ToUInt16((65535.0! _
                            * ((fVal - fLow) _
                            / (fHigh - fLow))))
            If Not m_adamModbusSocket.AnalogOutput.SetSafetyValues(Me.m_iSlot_ID, iChannelTotal, usAOSafetyVals) Then
                MessageBox.Show(("Set safety value failed! (Err: " _
                                + (m_adamModbusSocket.AnalogOutput.ApiLastError.ToString + ")")), "Error", MessageBoxButtons.OK, MessageBoxIcon.Hand, MessageBoxDefaultButton.Button1)
            End If
            RefreshSafetySetting()
    ...
    Private Sub Form_APAX_5028_FormClosing(ByVal sender As System.Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles MyBase.FormClosing
        FreeResource()
    End Sub
End Class
