...
Public Class Form_APAX_5017PE
    ...
    Public Function SetIp() As Boolean
        ...
        While (count <= 3) And m_szIP = Nothing
    ...
    Private Sub tcRemote_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tcRemote.SelectedIndexChanged
        ...
        ElseIf (strSelPageName = "AI") Then
            ...
            End If
            If (m_aConf.GetModuleName = "5017" OrElse m_aConf.GetModuleName = "5017PE") Then
    ...
    Public Function RefreshConfiguration() As Boolean
        ...
        If m_adamModbusSocket.Configuration.GetModuleConfig(m_iSlot_ID, m_aConf) Then
            ...
            Me.txtAIOFwVer.Text = m_aConf.wHwVer.ToString("X04").Insert(2, ".") 'AI Firmware version
        Else
            Me.StatusBar_IO.Text = (" GetModuleConfig(Error:" + (m_adamModbusSocket.Configuration.ApiLastError.ToString + ") Failed! "))
            Return False
        End If
    ...
    Public Sub InitialRemotePanelComponents()
        ...
        ElseIf (iIndex = 1) Then
            m_adamModbusSocket.Configuration.GetModuleTotalRange(CType(m_iSlot_ID, Integer), m_aConf, 1)
            m_usRanges_supAI = m_aConf.wHwIoType_1_Range
        ElseIf (iIndex = 2) Then
            m_adamModbusSocket.Configuration.GetModuleTotalRange(CType(m_iSlot_ID, Integer), m_aConf, 2)
            m_usRanges_supAI = m_aConf.wHwIoType_2_Range
        ElseIf (iIndex = 3) Then
            m_adamModbusSocket.Configuration.GetModuleTotalRange(CType(m_iSlot_ID, Integer), m_aConf, 3)
            m_usRanges_supAI = m_aConf.wHwIoType_3_Range
        Else
            m_adamModbusSocket.Configuration.GetModuleTotalRange(CType(m_iSlot_ID, Integer), m_aConf, 4)
        ...
        ElseIf (m_aConf.GetModuleName = "5017" OrElse m_aConf.GetModuleName = "5017PE") Then
    ...
    Public Function ReadChannelStatus() As Boolean
        ...
        If (Me.m_uiChMask <> 0) Then
            ...
            If Not Me.m_adamModbusSocket.AnalogInput.GetChannelStatus(Me.m_iSlot_ID, Me.m_iAIChannelNum, m_aStatus) Then
                Me.StatusBar_IO.Text = (StatusBar_IO.Text + ("[GetChannelStatus] ApiErr:" _
                            + (m_adamModbusSocket.AnalogInput.ApiLastError.ToString + " ")))
                Return False
            End If

            If Not m_adamModbusSocket.AnalogInput.GetValues(Me.m_iSlot_ID, Me.m_iAIChannelNum, m_usInVal) Then
    ...
    Public Function Update_AI_UIStatus() As Boolean
        ...
        If m_usInVal.Length > 0 Then
            ...
            For i = 0 To Me.m_iAIChannelNum - 1
                ...
                If listViewChInfo.Items(i).SubItems(3).Text <> strVal(i).ToString Then
                    listViewChInfo.Items(i).SubItems(3).Text = strVal(i).ToString 'moduify "Value" column
                End If

                If listViewChInfo.Items(i).SubItems(4).Text <> strStatus(i).ToString Then
    ...
    Private Sub Timer1_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Timer1.Tick
        ...
        bRet = RefreshData() 'Upadate channel status
    ...
    Private Function RefreshRanges() As Boolean
        ...
        Try
            ...
            If Me.m_adamModbusSocket.Configuration.GetModuleConfig(m_iSlot_ID, m_aConf) Then
    ...
    Private Sub RefreshAiSetting()
        ...
        If m_adamModbusSocket.Configuration.GetModuleConfig(Me.m_iSlot_ID, m_aConf) Then

            Dim uiFcnParam As UInteger  'Check if support SampleRate
    ...
    Private Function RefreshBurnoutSetting(ByVal bUpdateBurnFun As Boolean, ByVal bUpdateBurnVal As Boolean) As Boolean
        ...
        Try
            ...
            If bUpdateBurnFun Then
                If Not m_adamModbusSocket.AnalogInput.GetBurnoutFunEnable(m_iSlot_ID, o_dwEnableMask) Then
                    bRet = False
                Else
                    bRet = True
            ...
            If bUpdateBurnVal Then
                If Not m_adamModbusSocket.AnalogInput.GetBurnoutValue(m_iSlot_ID, o_dwValue) Then
                    bRet = False
                Else
                    bRet = True
    ...
    Private Sub RefreshAiSampleRate()
        ...
        If m_adamModbusSocket.AnalogInput.GetSampleRate(m_iSlot_ID, uiRate) Then
            If (m_aConf.GetModuleName = "5017" OrElse m_aConf.GetModuleName = "5017PE") Then
                If (uiRate = 1) Then
                    idx = 0
        ...
        Else
            StatusBar_IO.Text = (StatusBar_IO.Text + ("GetSampleRate (Err : " _
                        + (m_adamModbusSocket.AnalogInput.ApiLastError.ToString + ") Failed! ")))
        End If
    ...
    Private Sub btnApplySelRange_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnApplySelRange.Click
        ...
        If bRet Then
            ...
            Else
                ...
                Next
            End If
            If m_adamModbusSocket.AnalogInput.SetRanges(Me.m_iSlot_ID, Me.m_iAIChannelNum, usRanges) Then
                RefreshRanges()
            Else
    ...
    Private Sub btnBurnoutValue_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBurnoutValue.Click
        ...
        If m_adamModbusSocket.AnalogInput.SetBurnoutValue(Me.m_iSlot_ID, uiVal) Then
    ...
    Private Sub btnSampleRate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSampleRate.Click
        ...
        If m_adamModbusSocket.AnalogInput.SetSampleRate(Me.m_iSlot_ID, uiRate) Then
    ...
    Private Sub settingAI_MaskSetting(ByVal bEnable As Boolean, ByVal i_bApplyAll As Boolean) ' Enable/Disable Channel mask function
        ...
        If bRet Then
            ...
            Else
                If m_adamModbusSocket.AnalogInput.SetChannelEnabled(Me.m_iSlot_ID, uiMask) Then
                    RefreshRanges()
                Else
    ...
    Private Sub btnIntegration_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnIntegration.Click
        ...
        If m_adamModbusSocket.AnalogInput.SetIntegration(m_iSlot_ID, uiVal) Then
    ...
    Private Sub Form_APAX_5017PE_FormClosing(ByVal sender As System.Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles MyBase.FormClosing
        FreeResource()
    End Sub
End Class
