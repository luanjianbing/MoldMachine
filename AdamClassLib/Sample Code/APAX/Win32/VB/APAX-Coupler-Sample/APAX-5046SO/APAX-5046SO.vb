...
Public Class FORM_APAX_5046SO
    ...
    Private Sub FORM_APAX_5046SO_FormClosing(ByVal sender As System.Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles MyBase.FormClosing
        FreeResource()
    End Sub
End Class