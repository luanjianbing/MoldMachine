...
Public Class Form_APAX_5018
    ...
    Public Function FreeResource() As Boolean
        ...
        If m_bStartFlag Then
            ...
            m_adamCtl.Configuration.SYS_SetLocateModule(m_iSlot_ID, 0)  'disable locate module
            m_adamCtl = Nothing
    ...
    Public Function RefreshConfiguration() As Boolean
        ...
        Else
            Me.StatusBar_IO.Text = (" GetModuleConfig(Error:" + (m_adamCtl.Configuration.ApiLastError.ToString + ") Failed! "))
            Return False
        End If
