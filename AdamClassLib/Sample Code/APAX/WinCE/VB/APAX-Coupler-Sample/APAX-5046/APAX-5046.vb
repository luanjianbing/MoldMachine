...
Public Class FORM_APAX_5046

    'Global

    Dim APAX_INFO_NAME As String = "APAX"
    Public Const DVICE_TYPE = "5046"
    ...
    Public Function DeviceFind() As Boolean
        ...
        If m_iSlot_ID = -1 Then
            ...
            For iLoop = 0 To m_szSlots.Length - 1
                If m_szSlots(iLoop) = Nothing Then
                    Continue For
                End If
                If (String.Compare(m_szSlots(iLoop), 0, DVICE_TYPE, 0, DVICE_TYPE.Length) = 0 And m_szSlots(iLoop).Length = DVICE_TYPE.Length) Then
        ...
        Else
            ...
            If (String.Compare(m_szSlots(m_iSlot_ID), 0, DVICE_TYPE, 0, DVICE_TYPE.Length) = 0 And m_szSlots(m_iSlot_ID).Length = DVICE_TYPE.Length) Then
                iDeviceNum = iDeviceNum + 1
            End If
    ...
    Private Function RefreshData() As Boolean ' Refresh DO Channel Information "Value" column
        ...
        For i = 0 To bVal.Length - 1
            If listViewChInfo.Items(i).SubItems(3).Text <> bVal(i).ToString Then
                listViewChInfo.Items(i).SubItems(3).Text = bVal(i).ToString
    ...
    Private Sub APAX_5046_Closing(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles MyBase.Closing
        FreeResource()
    End Sub
End Class