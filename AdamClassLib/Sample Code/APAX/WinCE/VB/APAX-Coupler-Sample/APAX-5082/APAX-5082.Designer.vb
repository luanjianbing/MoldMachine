...
Partial Public Class Form_APAX_5082
    ...
    Private Sub InitializeComponent()
        ...
        Me.clmPWNAddr = New System.Windows.Forms.ColumnHeader
        ...
        Me.listViewChInfo_DI.Columns.Add(Me.clmAddr)
        ...
        Me.listViewChInfo_DO.Columns.Add(Me.clmDOAddr)
        ...
        Me.clmDOValue.Width = 50
        '
        'clmDOMode
        '
        Me.clmDOMode.Text = "Mode"
        Me.clmDOMode.Width = 76
        '
        'clmDOSafety
        '
        Me.clmDOSafety.Text = "Safety Value"
        Me.clmDOSafety.Width = 108
        '
        'panel1
        '
        ...
        Me.listViewChInfo_PWM.Columns.Add(Me.clmPWNAddr)
        ...
        '
        Me.clmPWMCh.Text = "CH"
        Me.clmPWMCh.Width = 45
        '
        'clmPWMStatus
        '
        Me.clmPWMStatus.Text = "Status"
        Me.clmPWMStatus.Width = 54
        '
        'clmPWMFreq
        '
        Me.clmPWMFreq.Text = "Frequency (Hz)"
        Me.clmPWMFreq.Width = 100
        '
        'clmPWMDutyCycle
        '
        Me.clmPWMDutyCycle.Text = "Duty Cycle (%)"
        Me.clmPWMDutyCycle.Width = 106
        '
        'panelPWMSetting
        '
        ...
        Me.clmDOAddr.Width = 93
        '
        'clmPWNAddr
        '
        Me.clmPWNAddr.Text = "Modbus Addr"
        Me.clmPWNAddr.Width = 86
        '
        'Form_APAX_5082
        '
    ...
    Private WithEvents clmPWNAddr As System.Windows.Forms.ColumnHeader
