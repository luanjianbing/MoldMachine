...
Public Class Form_APAX_Coupler
    ...
    Public Sub New()
        ...
        Else
            ...
            Me.tabControl1.Controls.RemoveAt(Me.tabControl1.Controls.Count - 1) 'Remove tabAddressSetting
            Me.tabControl1.Controls.RemoveAt(Me.tabControl1.Controls.Count - 1) 'Remove tabSerial
        End If
    ...
    Private Sub chbxEnCommFSV_CheckStateChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chbxEnCommFSV.CheckStateChanged
