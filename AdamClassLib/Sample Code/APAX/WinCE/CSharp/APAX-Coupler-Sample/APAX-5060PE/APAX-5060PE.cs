...
{
    public partial class Form_APAX_5060PE : Form
    {
        // Global object
        const string APAX_INFO_NAME = "APAX";
        const string  DVICE_TYPE = "5060PE";
        ...
        public Form_APAX_5060PE(string IP, int SlotNum, int ScanTime, AdamType i_adamType)
        {
            InitializeComponent();
            m_szSlots = null;
        ...
        {
            int i = 0, idx = 0;
            byte type = (byte)_HardwareIOType.DO;   //APAX-5060 is DO module
            ListViewItem lvItem;
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
       private void tcRemote_SelectedIndexChanged(object sender, EventArgs e)
        {
            string strSelPageName = tabControl1.TabPages[tabControl1.SelectedIndex].Text;
            StatusBar_IO.Text = "";
            m_adamSocket.Disconnect();
       ...
       private void Form_APAX_5060PE_Closing(object sender, System.ComponentModel.CancelEventArgs e)
       {
           FreeResource();
       }
