...
{
    public partial class Form_APAX_5017PE : Form
    {
        // Global object
        const string APAX_INFO_NAME = "APAX";
        const string  DVICE_TYPE = "5017PE";
        ...
        public Form_APAX_5017PE(string IP, int SlotNum, int ScanTime, AdamType i_adamType)
        {
            InitializeComponent();
            m_szSlots = null;
        ...
        private void chbxHide_CheckStateChanged(object sender, EventArgs e)
        {
        ...
        private void tabControl1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else if (strSelPageName == "AI")
            {
                ...
                if (m_aConf.GetModuleName() == "5017" || m_aConf.GetModuleName() == "5017PE")
                    RefreshBurnoutSetting(false, true);

                if (m_aConf.GetModuleName() == "5017" || m_aConf.GetModuleName() == "5017H" || m_aConf.GetModuleName() == "5017PE")
                    RefreshAiSampleRate();
            }
        ...
        private void RefreshAiSampleRate()
        {
            ...
            if (m_adamSocket.AnalogInput().GetSampleRate(m_idxID, out uiRate))
            {
                ...
                StatusBar_IO.Text += "GetSampleRate (Err : " + m_adamSocket.Modbus().LastError.ToString() + ") Failed! ";
        }
        ...
        private void btnApplySelRange_Click(object sender, EventArgs e)
        {
            ...
            if (bRet)
            {
                ...
                if (m_adamSocket.AnalogInput().SetRanges(this.m_idxID, iChannelTotal, usRanges))
                {
                    RefreshRanges();
                }
                else
        ...
        private void settingAI_MaskSetting(bool bEnable, bool i_bApplyAll)
        {
            ...
            if (bRet)
            {
                ...
                {
                    if (m_adamSocket.AnalogInput().SetChannelEnabled(m_idxID, uiMask))
                        RefreshRanges();
                    else
        ...
        private void btnIntegration_Click(object sender, EventArgs e)
        {
            ...
            if (m_adamSocket.AnalogInput().SetIntegration(m_idxID, uiVal))
            {
        ...
        private void btnBurnoutValue_Click(object sender, EventArgs e)
        {
            ...
            if (!CheckControllable())
                return;
            timer1.Enabled = false;
            if (m_adamSocket.AnalogInput().SetBurnoutValue(this.m_idxID, uiVal))
            {
        ...
        private void btnSampleRate_Click(object sender, EventArgs e)
        {
            ...
            if (m_adamSocket.AnalogInput().SetSampleRate(this.m_idxID, uiRate))
            {
        ...
        private void Form_APAX_5017PE_Closing(object sender, System.ComponentModel.CancelEventArgs e)
        {
            FreeResource();
        }
