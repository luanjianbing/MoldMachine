...
Public Class Form1
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If (m_Adam6000Type = Adam6000Type.Adam6250) Then
            InitAdam6250()
        ElseIf (m_Adam6000Type = Adam6000Type.Adam6251) Then
            InitAdam6251()
        ElseIf (m_Adam6000Type = Adam6000Type.Adam6256) Then
            InitAdam6256()
        ElseIf (m_Adam6000Type = Adam6000Type.Adam6260) Then
            InitAdam6260()
        ElseIf (m_Adam6000Type = Adam6000Type.Adam6266) Then
            InitAdam6266()
        End If
    End Sub
    ...
    Protected Sub InitAdam6250()
        ...
        InitChannelItems(False, False, iDI, iDO, panelCh15, btnCh15, cbxWDT15)
        InitChannelItems(False, False, iDI, iDO, panelCh16, btnCh16, cbxWDT16)
        InitChannelItems(False, False, iDI, iDO, panelCh17, btnCh17, cbxWDT17)

        m_iDoTotal = iDO
        m_iDiTotal = iDI
    End Sub

    Protected Sub InitAdam6251()
        Dim iDI As Integer = 0, iDO As Integer = 0
    ...
    Protected Sub InitAdam6256()
        Dim iDI As Integer = 0, iDO As Integer = 0

        InitChannelItems(True, False, iDI, iDO, panelCh0, btnCh0, cbxWDT0)
        InitChannelItems(True, False, iDI, iDO, panelCh1, btnCh1, cbxWDT1)
        InitChannelItems(True, False, iDI, iDO, panelCh2, btnCh2, cbxWDT2)
        InitChannelItems(True, False, iDI, iDO, panelCh3, btnCh3, cbxWDT3)
        InitChannelItems(True, False, iDI, iDO, panelCh4, btnCh4, cbxWDT4)
        InitChannelItems(True, False, iDI, iDO, panelCh5, btnCh5, cbxWDT5)
    ...
    Protected Sub InitAdam6260()
        ...
        InitChannelItems(True, False, iDI, iDO, panelCh4, btnCh4, cbxWDT4)
        InitChannelItems(True, False, iDI, iDO, panelCh5, btnCh5, cbxWDT5)
        InitChannelItems(False, False, iDI, iDO, panelCh6, btnCh6, cbxWDT6)
        InitChannelItems(False, False, iDI, iDO, panelCh7, btnCh7, cbxWDT7)
        InitChannelItems(False, False, iDI, iDO, panelCh8, btnCh8, cbxWDT8)
        InitChannelItems(False, False, iDI, iDO, panelCh9, btnCh9, cbxWDT9)
        InitChannelItems(False, False, iDI, iDO, panelCh10, btnCh10, cbxWDT10)
        InitChannelItems(False, False, iDI, iDO, panelCh11, btnCh11, cbxWDT11)
        InitChannelItems(False, False, iDI, iDO, panelCh12, btnCh12, cbxWDT12)
        InitChannelItems(False, False, iDI, iDO, panelCh13, btnCh13, cbxWDT13)
        InitChannelItems(False, False, iDI, iDO, panelCh14, btnCh14, cbxWDT14)
        InitChannelItems(False, False, iDI, iDO, panelCh15, btnCh15, cbxWDT15)
        InitChannelItems(False, False, iDI, iDO, panelCh16, btnCh16, cbxWDT16)
        InitChannelItems(False, False, iDI, iDO, panelCh17, btnCh17, cbxWDT17)
    ...
    Private Sub RefreshDIO()
        ...
        If (m_Adam6000Type = Adam6000Type.Adam6251) Then
        ...
        ElseIf ((m_Adam6000Type = Adam6000Type.Adam6256) Or (m_Adam6000Type = Adam6000Type.Adam6260)) Then

            If ((adamModbus.Modbus().ReadCoilStatus(iDoStart, m_iDoTotal, bDoData)) = True) Then
    ...
    Private Sub RefreshWDT()
        ...
        If (adamModbus.DigitalOutput().GetWDTMask(bCommFSV, bPtoPFSV, bWDT) AndAlso (bWDT.Length = 16)) Then
    ...
    Private Sub chbxCommWDT_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chbxCommWDT.CheckStateChanged
        If (chbxCommWDT.Checked AndAlso chbxPtoPWDT.Checked) Then
            chbxPtoPWDT.Checked = False
        End If
    End Sub

    Private Sub chbxPtoPWDT_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chbxPtoPWDT.CheckStateChanged
