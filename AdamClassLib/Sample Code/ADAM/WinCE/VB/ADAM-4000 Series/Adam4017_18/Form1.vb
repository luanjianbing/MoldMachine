...
Public Class Form1
    ...
    Private Sub Timer1_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Timer1.Tick
        ...
        If adamCom.AnalogInput(m_iAddr).GetValues(8, values, status) = True Then
            ...
            RefreshValue(txtAIValue6, status(6), values(6))
            RefreshValue(txtAIValue7, status(7), values(7))
        Else
    ...
    Private Sub RefreshChannelEnable()
        ...
        If adamCom.AnalogInput(m_iAddr).GetChannelEnabled(8, bEnabled) = True Then
