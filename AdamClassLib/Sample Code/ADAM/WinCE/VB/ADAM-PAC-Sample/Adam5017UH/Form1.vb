...
#Region " Windows Form Designer generated code "
    ...
    Private Sub InitializeComponent()
        ...
        Me.Text = "Adam5017UH sample program (VB)"
...
#End Region
    ...
    Private Function RefreshRange(ByVal i_iChannel As Integer) As Boolean
        ...
        bRet = adamCtl.AnalogInput().GetInputRange(m_iSlot, i_iChannel, byRange)
    ...
    Private Sub RefreshChannelValue()
        ...
        If adamCtl.AnalogInput().GetValues(m_iSlot, m_iChTotal, fValue) = True Then
            ' 
