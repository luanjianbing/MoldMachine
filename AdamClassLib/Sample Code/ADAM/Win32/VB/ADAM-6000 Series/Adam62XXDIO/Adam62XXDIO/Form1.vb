...
Public Class Form1
    ...
    Private Sub chbxCommWDT_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chbxCommWDT.CheckedChanged
        If (chbxCommWDT.Checked AndAlso chbxPtoPWDT.Checked) Then
            chbxPtoPWDT.Checked = False
        End If
    End Sub

    Private Sub chbxPtoPWDT_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chbxPtoPWDT.CheckedChanged
